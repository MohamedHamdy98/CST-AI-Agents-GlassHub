...
router = APIRouter(prefix="/api/v1/enterprise/organization", tags=["Enterprise Organization Chat"])
...
async def non_compliance_chat_enterprise_organizations(
...
async def general_chat_enterprise_organizations(
    user_message: str = Form(...),
