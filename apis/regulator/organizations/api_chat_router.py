...
router = APIRouter(prefix="/api/v1/regulator/organization", tags=["Regulator Organization Chat"])
...
async def non_compliance_chat_reg_organizations(
...
async def general_chat_reg_organizations(
    user_message: str = Form(...),
