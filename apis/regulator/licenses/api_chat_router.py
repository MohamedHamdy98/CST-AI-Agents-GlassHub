...
router = APIRouter(prefix="/api/v1/regulator/licenses", tags=["Regulator Licenses Chat"])
...
async def non_compliance_chat_reg_licenses(
...
async def general_chat_reg_licenses(
    user_message: str = Form(...),
